...
--  ORA-00955: 기존의 객체가 이름을 사용하고 있습니다.  실패 > 이름 중복
-- CREATE 다음에 OR REPLACE를 추가 후 실행 > 성공
...
--> ORA-01400: NULL을 ("KH_BSH"."DEPT_COPY2"."DEPT_TITLE") 안에 삽입할 수 없습니다

-- 	VIEW의 본래 목적인 보여지는 것(조회)의 용도에 맞게 사용하는게 좋다
